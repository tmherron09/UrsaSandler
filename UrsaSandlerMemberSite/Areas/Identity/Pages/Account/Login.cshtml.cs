...
namespace UrsaSandlerMemberSite.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<ClubMember> signInManager, 
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var username = _dataService.GetUserFirstName(Input.Email);
                ...
                {
                    //Add email/password recovery logic.
